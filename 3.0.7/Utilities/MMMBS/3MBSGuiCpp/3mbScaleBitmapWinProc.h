#ifndef _3MBSCALEBITMAPWINPROC
#define _3MBSCALEBITMAPWINPROC
...
enum BATHYSCALETYPE
{
	NONE_SCALETYPE = 0, // No special operation
	BITMAPZOOMTYPE = 1, // Means either the dialog box was resized or the bitmap was zoomed in or out.
	DEPTHSCALETYPE = 2, // means the depth scale changed.
	SLOPESCALETYPE = 3, // means the slope scale changed.
};

#endif // ifdef _3MBSCALEBITMAPWINPROC