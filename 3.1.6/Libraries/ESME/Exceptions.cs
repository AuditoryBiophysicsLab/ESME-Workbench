...
namespace ESME
{
    ...
    [Serializable]
    public class WaypointFileFormatException : Exception
    {
        //
        // For guidelines regarding the creation of new exception types, see
        //    http://msdn.microsoft.com/library/default.asp?url=/library/en-us/cpgenref/html/cpconerrorraisinghandlingguidelines.asp
        ...
        public WaypointFileFormatException(string message) : base(message) { }
        public WaypointFileFormatException(string message, Exception inner) : base(message, inner) { }

        protected WaypointFileFormatException(
            SerializationInfo info,
            StreamingContext context) : base(info, context) { }
    }
