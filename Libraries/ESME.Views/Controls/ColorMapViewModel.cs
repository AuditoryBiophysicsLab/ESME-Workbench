    ...
    public class ColorMapViewModel : ViewModelBase
    {
        public ColorMapViewModel()
        {
            ...
            _observers.Add(DataRange
                               ...
                               .Subscribe(r => Debug.WriteLine(string.Format("{0:HH:mm:ss:fff} ColorMapViewModel.DataRange changed to {1}", DateTime.Now, DataRange))));
            _observers.Add(FullAxisRange
                               .ObserveOn(TaskPoolScheduler.Default)
                               .Subscribe(r => Debug.WriteLine(string.Format("{0:HH:mm:ss:fff} ColorMapViewModel.FullAxisRange changed to {1}", DateTime.Now, FullAxisRange))));
        ...
        #region public static default colormap dictionary

        public static Dictionary<string, Color[]> Colormaps = new Dictionary<string, Color[]>
        {
            {
                "Jet", new[]
                {
        ...
        public static ColorMapViewModel DesignTimeData
        {
            get
            {
