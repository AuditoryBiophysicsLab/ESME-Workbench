...
namespace ESME.Environment.NAVO
{
    public class DBDBBackgroundExtractor : NAVOBackgroundExtractor
    {
        protected override async void Run(object sender, DoWorkEventArgs e)
        {
            ...
            var result = await NAVOExtractionProgram.Execute(backgroundExtractor.NAVOConfiguration.DBDBEXEPath, commandArgs, backgroundExtractor.DestinationPath);
            backgroundExtractor.Value++;
        ...
        public static async void Extract(string outputPath, string selectedResolution, GeoRect extractionArea, IProgress<TaskProgressInfo> progress = null)
        {
