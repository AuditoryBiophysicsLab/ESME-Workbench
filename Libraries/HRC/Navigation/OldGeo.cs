...
{
    [Serializable]
    public class OldGeo : EqualityComparer<OldGeo>, IEquatable<OldGeo>, IComparable<OldGeo>, IComparer<OldGeo>, INotifyPropertyChanged, IDeserializationCallback
    {
     ...
     */
        public OldGeo(double lat, double lon) { Initialize(lat, lon); }
     ...
     */
        ...
        public OldGeo(double lat, double lon, bool isDegrees)
        {
        ...
        public OldGeo(double x, double y, double z)
        {
            X = x;
            Y = y;
            Z = z;
        ...
        public OldGeo(OldGeo geo) : this(geo.X, geo.Y, geo.Z) { }

        public OldGeo(OldGeo geo, double azimuthDegrees, double distanceMeters)
        {
        ...
        public static OldGeo FromRadians(double latr, double lonr)
        {
            var rlat = GeocentricLatitude(latr);
            var c = Math.Cos(rlat);
            return new OldGeo(c * Math.Cos(lonr), c * Math.Sin(lonr), Math.Sin(rlat));
        }

        public static OldGeo FromDegrees(double latd, double lond) { return FromRadians(DegreesToRadians(latd), DegreesToRadians(lond)); }

        public static OldGeo FromXYZ(double x, double y, double z) { return new OldGeo(x, y, z); }

        public static OldGeo FromGeo(OldGeo p) { return new OldGeo(p.X, p.Y, p.Z); }

        public static OldGeo Move(OldGeo geo, double azimuthDegrees, double distanceMeters)
        {
            return geo.Offset(KilometersToRadians(distanceMeters / 1000), DegreesToRadians(azimuthDegrees));
        }

        public OldGeo Move(double azimuthDegrees, double distanceMeters)
        {
     ...
     * @return midpoint Geo.
     */
        public OldGeo MidPoint(OldGeo g2) { return Add(g2).Normalize(); }
     ...
     * @return midpoint Geo.
     */
        public OldGeo MidPoint(OldGeo g2, OldGeo ret) { return Add(g2).Normalize(); }

        public OldGeo Interpolate(OldGeo g2, double x) { return Scale(x).Add(g2.Scale(1 - x)).Normalize(); }
        ...
        public static OldGeo Deserialize(BinaryReader reader)
        {
            var x = reader.ReadDouble();
            var y = reader.ReadDouble();
            var z = reader.ReadDouble();
            return new OldGeo(x, y, z);
        }
        ...
        ///   North pole
        /// </summary>
        public static OldGeo North = new OldGeo(0.0, 0.0, 1.0);
        ...
        /// <param name = "b"></param>
        /// <returns></returns>
        public double Dot(OldGeo b) { return ((X * b.X) + (Y * b.Y) + (Z * b.Z)); }
        ...
        /// <param name = "b"></param>
        /// <returns></returns>
        public static double Dot(OldGeo a, OldGeo b) { return ((a.X * b.X) + (a.Y * b.Y) + (a.Z * b.Z)); }
        ...
        /// <param name = "s"></param>
        /// <returns></returns>
        public OldGeo Scale(double s) { return new OldGeo(X * s, Y * s, Z * s); }

        /// <summary>
        ///   Returns a unit length vector parallel to this.
        /// </summary>
        /// <returns></returns>
        public OldGeo Normalize() { return Scale(1.0 / Length); }
        ...
        /// <param name = "b"></param>
        /// <returns></returns>
        public OldGeo Cross(OldGeo b) { return new OldGeo(Y * b.Z - Z * b.Y, Z * b.X - X * b.Z, X * b.Y - Y * b.X); }
        ...
        /// <param name = "b"></param>
        /// <returns></returns>
        public double CrossLength(OldGeo b) { return Cross(b).Length; }
        ...
        /// <param name = "b"></param>
        /// <returns></returns>
        public OldGeo CrossNormalize(OldGeo b) { return Cross(b).Normalize(); }
        ...
        /// <param name = "b"></param>
        /// <returns></returns>
        public static OldGeo CrossNormalize(OldGeo a, OldGeo b) { return a.CrossNormalize(b); }
        ...
        /// <param name = "b"></param>
        /// <returns></returns>
        public OldGeo Add(OldGeo b) { return new OldGeo(X + b.X, Y + b.Y, Z + b.Z); }
        ...
        /// <param name = "b"></param>
        /// <returns></returns>
        public OldGeo Subtract(OldGeo b) { return new OldGeo(X - b.X, Y - b.Y, Z - b.Z); }
        ...
        /// <param name = "v2"></param>
        /// <returns></returns>
        public bool Equals(OldGeo v2) { return X == v2.X && Y == v2.Y && Z == v2.Z; }
        ...
        /// <param name = "v2"></param>
        /// <returns></returns>
        public double DistanceRadians(OldGeo v2) { return Math.Atan2(v2.CrossLength(this), v2.Dot(this)); }
        ...
        /// <param name = "v2"></param>
        /// <returns></returns>
        public static double DistanceRadians(OldGeo v1, OldGeo v2) { return v1.DistanceRadians(v2); }
        ...
        /// <returns></returns>
        public static double DistanceRadians(double lat1, double lon1, double lat2, double lon2) { return DistanceRadians(new OldGeo(lat1, lon1), new OldGeo(lat2, lon2)); }
        ...
        /// <param name = "v2"></param>
        /// <returns></returns>
        public double DistanceKilometers(OldGeo v2) { return RadiansToKilometers(DistanceRadians(v2)); }
        ...
        /// <param name = "v2"></param>
        /// <returns></returns>
        public static double DistanceKilometers(OldGeo v1, OldGeo v2) { return v1.DistanceKilometers(v2); }
        ...
        /// <param name = "lon2"></param>
        /// <returns></returns>
        public static double DistanceKilometers(double lat1, double lon1, double lat2, double lon2) { return DistanceKilometers(new OldGeo(lat1, lon1), new OldGeo(lat2, lon2)); }
        ...
        /// <param name = "v2"></param>
        /// <returns></returns>
        public double DistanceMeters(OldGeo v2) { return RadiansToKilometers(DistanceRadians(v2)) * 1000; }
        ...
        /// <param name = "v2"></param>
        /// <returns></returns>
        public static double DistanceMeters(OldGeo v1, OldGeo v2) { return v1.DistanceKilometers(v2) * 1000; }
        ...
        /// <param name = "lon2"></param>
        /// <returns></returns>
        public static double DistanceMeters(double lat1, double lon1, double lat2, double lon2) { return DistanceKilometers(new OldGeo(lat1, lon1), new OldGeo(lat2, lon2)) * 1000; }
        ...
        /// <param name = "v2"></param>
        /// <returns></returns>
        public double DistanceNauticalMiles(OldGeo v2) { return RadiansToNauticalMiles(DistanceRadians(v2)); }
        ...
        /// <param name = "v2"></param>
        /// <returns></returns>
        public static double DistanceNauticalMiles(OldGeo v1, OldGeo v2) { return v1.DistanceNauticalMiles(v2); }
        ...
        /// <param name = "lon2"></param>
        /// <returns></returns>
        public static double DistanceNauticalMiles(double lat1, double lon1, double lat2, double lon2) { return DistanceNauticalMiles(new OldGeo(lat1, lon1), new OldGeo(lat2, lon2)); }
        ...
        /// <param name = "v2"></param>
        /// <returns></returns>
        public double Azimuth(OldGeo v2)
        {
        ...
        public double AzimuthDegrees(OldGeo v2) { return Azimuth(v2) * (180.0 / Math.PI); }
        ...
        /// <param name = "p2"></param>
        /// <returns></returns>
        public static double AngleRadians(OldGeo p0, OldGeo p1, OldGeo p2) { return Math.PI - p0.Cross(p1).DistanceRadians(p1.Cross(p2)); }
        ...
        /// <param name = "p"></param>
        /// <returns></returns>
        public bool IsInside(OldGeo v2, double radius, OldGeo p)
        {
        ...
        /// <param name = "p2"></param>
        /// <returns></returns>
        public static bool IsInside(OldGeo v1, OldGeo v2, double radius, OldGeo p1, OldGeo p2) { return v1.IsInside(v2, radius, p1) || v1.IsInside(v2, radius, p2) || p1.IsInside(p2, radius, v1) || p1.IsInside(p2, radius, v2); }
        ...
        /// <returns></returns>
        public static bool IsInside(double lat1, double lon1, double lat2, double lon2, double radius, double lat3, double lon3) { return (new OldGeo(lat1, lon1)).IsInside(new OldGeo(lat2, lon2), radius, new OldGeo(lat3, lon3)); }
     ...
     */
        public bool InBubble(OldGeo v2, double forwardRadius, double backRadius, OldGeo p) { return DistanceRadians(p) <= ((v2.Subtract(this).Normalize().Dot(p.Subtract(this)) > 0.0) ? forwardRadius : backRadius); }

        /** Returns the point opposite this point on the earth. */
        public OldGeo Antipode() { return Scale(-1.0); }
     ...
     */
        ...
        public OldGeo Intersect(OldGeo q, OldGeo r)
        {
            var a = Dot(r);
            var b = q.Dot(r);
            var x = -b / (a - b);
        ...
        /// <returns></returns>
        public static OldGeo[] ApproximateArc(OldGeo pc, OldGeo p0, OldGeo p1, double err)
        {
            ...
            for (var i = 1; i < n - 1; i++)
            {
                ...
                result[i] = OldRotation.Rotate(pc, 2.0 * Math.PI - rho, p0);
            }
            result[n - 1] = p1;
        ...
        public OldGeo[] ApproximateArc(OldGeo p0, OldGeo p1, double err) { return ApproximateArc(this, p0, p1, err); }
        ...
        /// <returns></returns>
        public OldGeo Offset(double distance, double azimuth)
        {
            ...
            var p = OldRotation.Rotate(m, distance, this);
            // Rotate p around this so it has the right azimuth.
            return OldRotation.Rotate(this, 2.0 * Math.PI - azimuth, p);
        }
        ...
        /// <returns></returns>
        public static OldGeo Offset(OldGeo origin, double distance, double azimuth) { return origin.Offset(distance, azimuth); }

        public static explicit operator Point(OldGeo e) { return new Point(e.Longitude, e.Latitude); }
        public static explicit operator PointF(OldGeo e) { return new PointF((float)e.Longitude, (float)e.Latitude); }
     ...
     */
        ...
        */
        ...
        public override bool Equals(OldGeo x, OldGeo y) { return (x.DistanceKilometers(y) < 0.01); }

        public override int GetHashCode(OldGeo obj)
        {
        ...
        public int CompareTo(OldGeo other) { return Compare(this, other); }
        int IComparer<OldGeo>.Compare(OldGeo e1, OldGeo e2) { return e1.Compare(e2); }
        public static int Compare(OldGeo e1, OldGeo e2) { return e1.Compare(e2); }
        public int Compare(OldGeo e2)
        {
    ...
    public class OldGeo<T> : OldGeo
    {
        public OldGeo() {}
        public OldGeo(double lat, double lon) : base(lat, lon) { }
        public OldGeo(double lat, double lon, bool isDegrees) : base(lat, lon, isDegrees) { }
        public OldGeo(double lat, double lon, T data) : base(lat, lon) { Data = data; }
        public OldGeo(double x, double y, double z) : base(x, y, z) { }
        public OldGeo(OldGeo geo) : base(geo) { }
        public OldGeo(OldGeo geo, T data) : base(geo) { Data = data; }

        public T Data { get; set; }
    }

    public class OldRotation
    {
        readonly OldGeo _g;
        ...
        public OldRotation(OldGeo g, double angle)
        {
            _g = g;
            var x = _g.X;
            var y = _g.Y;
        ...
        public OldGeo Rotate(OldGeo v)
        {
            return new OldGeo(_m00 * v.X + _m01 * v.Y + _m02 * v.Z, _m10 * v.X + _m11 * v.Y + _m12 * v.Z, _m20 * v.X + _m21 * v.Y + _m22 * v.Z);
        }
        ...
        /// <param name="v2"></param>
        /// <returns></returns>
        public static OldGeo Rotate(OldGeo v1, double angle, OldGeo v2)
        {
            return new OldRotation(v1, angle).Rotate(v2);
        }
    }
}