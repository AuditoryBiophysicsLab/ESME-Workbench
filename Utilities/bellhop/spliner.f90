!     Last change:  MBP  26 Jun 2002   11:04 am
...
! **********************************************************************
      ...
      REAL (KIND=4) ::    TAU(N)
      REAL (KIND=4) :: C(4,NDIM), G, DTAU, DIVDF1, DIVDF3
...
!     VSPLINE CALCULATES THE CUBI! SPLINE VALUES FOR A SET OF N POINTS  
...
!     INTERVAL AGAIN RESULTING IN WILD VALUES.
      ...
      IMPLICIT REAL (KIND=4) (A-H,O-Z)
      REAL (KIND=4) ::     TAU(M)
      REAL (KIND=4) :: C(4,MDIM), F(N), SPLINE
