...
{
    public class RadialData : IComparable<RadialData>
    {
        ...
        public RadialData(float BearingFromSource_degrees, Bellhop.BellhopOutput BellhopOutput)
        {
        ...
        public RadialData(BinaryReader stream, bool HeaderOnly)
        {
            if (mSeekOffset == -1)
        ...
        public int CompareTo(RadialData Other)
        {
