...
! **********************************************************************
      ...
      REAL (KIND=8) ::    TAU(N)
      REAL (KIND=8) :: C(4,NDIM), G, DTAU, DIVDF1, DIVDF3
...
!     INTERVAL AGAIN RESULTING IN WILD VALUES.
      ...
      IMPLICIT REAL (KIND=8) (A-H,O-Z)
      REAL (KIND=8) ::     TAU(M)
      REAL (KIND=8) :: C(4,MDIM), F(N), SPLINE
